    ...
    $webpagetitle=$pagetitle="New Student";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="sname" id="sname" maxlength="50" data-validation-optional="false" data-validation="required" data-validation-error-msg="Invalid name">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="class" id="class" maxlength="30" data-validation-optional="false" data-validation="required" data-validation-error-msg="Invalid class">
