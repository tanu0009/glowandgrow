                            ...
                            <form role="form" id="addform">
                                ...
                                <input type="hidden" name="prodcount" id="prodcount" value="1" readonly>
                                 ...
                                 <div class="row">
                                	<div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Other Information<span class="require">*</span></label>
                                          <textarea class="form-control ckeditor" name="otherdata" id="otherdata" maxlength="500" rows="3" data-validation="required" data-validation-optional="false" data-validation-error-msg="Invalid description"></textarea>
                                        </div>
                                    </div>
                                    </div>
