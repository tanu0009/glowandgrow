...
$webpagetitle=$pagetitle="Student List";
include("header.php");
?>
<a href="<?php echo 'studentadd.php'?>" class="btn btn-primary pull-right">New student<i class="fa fa-plus mlm"></i></a>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover" id="dataTables-listing">
                                    ...
                                    <tbody>
                                        <?php
                                        $listq="SELECT * from wr_mst_student";
                                        ...
                                        <tr>
                                         <td><?php echo $i; ?></td>
                                         <td><?php echo $listrow['sname']; ?></td>
                                         <td><?php echo $listrow['branch'];?></td>
                                         <td><?php echo $listrow['class'];?></td>
                                          
                                         <td class="text-center">
                                            <form><button type="submit" name="id" value="<?php echo $listrow['sid']?>" formaction="<?php echo $pagename?>edit.php" class="btn btn-primary btn-sm" <?php if($trncnt>0){?> disabled="disabled"<?php }?>>Edit<i class="fa fa-pencil mlm"></i></button></form>
                                            </td>
                                        <td class="text-center">
                                            <button type="button" value="<?php echo $listrow['sid']?>" class="btn btn-sm btn-<?php if($listrow['active']!='n')echo "danger";else echo "success"?> delbtn" <?php if($trncnt>0){?> disabled="disabled"<?php }?>><?php if($listrow['active']=='n')echo 'Enable<i class="fa fa-check mlm"></i>';else echo 'Disable<i class="fa fa-close mlm"></i>'?></button>
                                        </td>
