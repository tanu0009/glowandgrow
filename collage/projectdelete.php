...
$selrimg=$connection->query("SELECT * FROM lad_mst_medicalequipment WHERE rec_id=".$_GET['id']);
...
$delr=$connection->query("DELETE FROM wr_mst_project WHERE pid=".$_GET['id']);
...
header("location:projectdelete.php?msg=".$msg);
