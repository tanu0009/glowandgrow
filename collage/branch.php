                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="dataTables-listing">
                                    ...
                                    <tbody>
                                        <?php
                                        $listq="SELECT * FROM lad_mst_branch order by cat_name asc";
                                        ...
                                        <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $listrow['cat_name']; ?></td>
                                         <td><?php echo $listrow['sortby']; ?></td>
                                       <td class="text-center"><form><button type="submit" name="id" value="<?php echo $listrow['cat_id']?>" formaction="<?php echo $pagename?>edit.php" class="btn btn-primary btn-sm">Edit<i class="fa fa-pencil mlm"></i></button></form></td>
                                            <td class="text-center"><button type="button" value="<?php echo $listrow['cat_id']?>" class="btn btn-sm btn-<?php if($listrow['active']!='n')echo "danger";else echo "success"?> delbtn"><?php if($listrow['active']=='n')echo 'Enable<i class="fa fa-check mlm"></i>';else echo 'Disable<i class="fa fa-close mlm"></i>'?></button></td>
                                            <td class="text-center"><form>
                                                                                       
                                            
                                <button type="submit" name="id" value="<?php echo $listrow['cat_id']?>" formaction="<?php echo $pagename?>delete.php" class="btn btn-danger btn-sm" onClick="return confDel()">Delete<i class="fa fa-trash mlm"></i></button></form></td>
